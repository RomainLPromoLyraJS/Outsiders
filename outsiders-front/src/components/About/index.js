      ...
      <section className="about__team">
        ...
        <article className="about__team__article">
          ...
          <p className="about__team__article__text">
            Le créateur à l'origine du site, l'homme qui a les idées. Sans lui,
            la terre serait sans doute encore plate, la vie encore à l'état
            mono-cellulaire, ce site n'existerait pas et peut-être même que toi
            non plus !
          </p>
        </article>
        <article className="about__team__article">
          ...
          <p className="about__team__article__text">
            ...
            cas de coup dur ! Avec lui, quand on fait les choses, "c'est carré"
            comme il dit.
          </p>
        </article>
        <article className="about__team__article">
        ...
        <article className="about__team__article">
          ...
          <p className="about__team__article__text">
            ...
            demandez pas de peindre une toile, il s'en moque, il a déjà dévissé
            le pinceau pour savoir comment ca se branche !
          </p>
        </article>
      </section>
    </main>
